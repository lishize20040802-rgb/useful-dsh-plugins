...
function normalizeConfig(raw) {
  ...
  const configuredInbox = typeof config.inboxDir === "string" ? config.inboxDir.trim() : "";
  const inboxDir = resolve(resolveDshHome(), expandHomePath(configuredInbox || "vision-inbox"));
  return {
    provider,
    model,
