...
export declare const zh: {
    ...
    readonly 'voice.error.bridge': "语音服务不可用（检查桥接配置后重启应用）";
    readonly 'voice.error.ark': "识别失败：{message}";
};
...
export declare const dicts: {
    ...
    en: Record<"voice.button" | "voice.hotkey" | "voice.recording" | "voice.processing" | "voice.listening" | "voice.silent" | "voice.error.mic" | "voice.error.short" | "voice.error.bridge" | "voice.error.ark", string>;
};
